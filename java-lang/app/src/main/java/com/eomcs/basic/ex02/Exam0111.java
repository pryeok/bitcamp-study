...
public class Exam0111 {
  public static void main(String[] args) {
    ...
    // 문자열 리터럴
    // - string constant pool(스트링 상수 풀) 메모리 영역에 String 인스턴스를 생성한다.
    // - string constant pool = 스트링 리터럴로 생성한 string 인스턴스를 두는 곳
    ...
    // 인스턴스의 주소를 비교해 보면,
    System.out.println(x1 == x2); // true => 두 String 객체는 같다. (인스턴스 주소가 같음)
  }
}
