...
public class Exam0112 {
  public static void main(String[] args) {
    ...
    //   => s 객체의 필드 값을 설정한다.
    // 
    s.name = "홍길동"; // s에 저장된 주소로 찾아가서 name 항목에 값 저장  // s라는 주소의 name 필드
    s.kor = 100; // s에 저장된 주소로 찾아가서 kor 항목에 값 저장    // s라는 주소의 korea 필드
    s.eng = 90;  // s라는 주소의 eng 필드
    s.math = 80;  // s라는 주소의 math 필드
